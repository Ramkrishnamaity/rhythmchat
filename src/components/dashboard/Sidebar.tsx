...
const Sidebar: React.FC<SidebarPropsType> = ({ showNavbar, setRight, right }) => {
    ...
    return (
        <div className={`bg-[white] text-lowBlack z-10 text-sm flex flex-col justify-center w-full h-full sm:w-[calc(30%-6px)] md:w-[calc(30%-10px)] rounded-xl p-5 ${!showNavbar ? 'hidden' : 'sm:relative absolute flex'} sm:block`}>
